...
all:
	...
	$(CC) $(CFLAGS) $(program_folder)user_com.c -o $(build_folder)user_com$(EXTENSION)
	$(CC) $(CFLAGS) $(build_folder)user_com.o $(program_folder)energy.c -o $(build_folder)energy$(EXTENSION)
