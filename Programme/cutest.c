...
void test_convert_kwh(CuTest* testContext){
    ...
    float correct_array[24] = {
        0.07207,0.09687,0.1372,0.01863,0.026170000000000002,0.10571,0.1497, 
        0.06312,0.1677,0.10424,0.08388,0.10940000000000001,
        0.055189999999999996, 0.10443999999999999, 0.04346, 0.10926999999999999,
        0.19590000000000002,0.10146,0.06991,0.14614,0.17294,
        0.16166999999999998,0.10867,0.11368
    };
    for(i = 0; i < 24; i++){
        temp = input_array[i];
        convert_kwh(&temp);
